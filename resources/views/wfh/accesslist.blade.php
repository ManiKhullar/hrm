            ...
            <div class="col-md-12">
                <div class="card ctm-border-radius shadow-sm grow">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Applied Employee Wfh List</h4>
                    </div>
                    <div class="card-body">
                        ...
                        if(isset($_GET['reset'])){
                            ...
                            <script>
                                window.location.href = "<?php echo url('/')."/accesswfhlist"; ?>";
                            </script>
                        <?php } ?>

                        <form action="{{ route('wfhfilter') }}" method="get">
                            <div class="col-md-12">
                                <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($leaveData->status == 1 || $leaveData->status == 0) { ?>
                                                    <a class="btn btn-primary" href="{{ url('accesswfh_edit/'.$leaveData->id) }}">Edit</a>
                                                <?php } ?>
                                            </td>     
                                        </tr>
                                        @endforeach
