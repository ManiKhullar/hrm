                ...
                <div class="card-body text-center">
                    ...
                    <form id="registerDetailsform">
                        ...
                        <div id="registerModal" class="modal">
                            ...
                            <div class="modal-content">
                                <span class="close" id="register_model">&times;</span>
                                <p class="msg"></p>
                                <div class="row">
                                    <div class="col-md-3 col-6 form-group">
                                        <label>Name</label>
                                        <input type="text" required class="form-control" name="name" id="emp_name" value="{{$employeeData[0]->name}}">
                                        <p id="emp_name_error" class="text-danger"></p>
                                    </div>
                                    <div class="col-md-3 col-6 form-group">
                                        <label>Email</label>
                                        <input type="text" required class="form-control" name="email" id="email" value="{{$employeeData[0]->email}}">
                                        <p id="email_error" class="text-danger"></p>
                                    </div>
                                    <div class="col-md-3 col-6 form-group">
                                        <label>Date Of Birth</label>
                                        <input type="date" required class="form-control" name="dob" id="dob" value="{{$employeeData[0]->dob}}">
                                        <p id="dob_error" class="text-danger"></p>
                                    </div>
                                    <div class="col-md-3 col-6 form-group">
                                        <label>Employee Salary <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="employee_salary" id="employee_salary" placeholder="Employee Salary" value="{{$employeeData[0]->salary}}">
                                        <p id="employee_salary_error" class="text-danger"></p>  
                                    </div>
                                    <div class="col-md-6 col-12 form-group">
                                        <p class="mb-2">Gender<span class="text-danger">*</span></p>
                                        <div class="custom-control-inline">
                                            <input type="radio" name="gender" value="male" class="" <?php if($employeeData[0]->gender=="male"){ echo "checked";} ?>>
                                            <label class=""
                                                for="Male">Male</label>
                                        </div>
                                        <div class="custom-control-inline">
                                            <input type="radio" name="gender" value="female" class=""<?php if($employeeData[0]->gender=="female"){ echo "checked";} ?>>
                                    ...
                                    <div class="col-md-6 col-12 form-group">
                                        ...
                                        <div class="custom-control-inline">
                                            <input type="radio"  
                                                name="blood_group" value="A+" <?php if($employeeData[0]->blood_group=="A+"){ echo "checked";} ?>>
                                            <label 
                                                for="A">A+</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" value="B+" 
                                                name="blood_group" <?php if($employeeData[0]->blood_group=="B+"){ echo "checked";} ?>>
                                            <label 
                                                for="B">B+</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" value="AB+" 
                                                name="blood_group" <?php if($employeeData[0]->blood_group=="AB+"){ echo "checked";} ?>>
                                            <label 
                                                for="AB">AB+</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" value="A-" <?php if($employeeData[0]->blood_group=="A-"){ echo "checked";} ?>
                                                name="blood_group">
                                            <label 
                                                for="A+">A-</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" value="O-" <?php if($employeeData[0]->blood_group=="o-"){ echo "checked";} ?>
                                                name="blood_group">
                                            <label 
                                                for="O">O-</label>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12 form-group">
                                        ...
                                        <input type="date" class="form-control" name="doj" id="doj" placeholder="Date of Joining" value="{{$employeeData[0]->joining_date}}" >
                                        <p id="doj_error" class="text-danger"></p>  
                                        </div>
                                        <div class="col-md-3 col-12 form-group">
                                            <label>Role <span class="text-danger">*</span></label>
                                            <select class="form-control select" name="department_role" id="department_role">
                                                <option value="">Select</option>
                                                @foreach ($departments as $department)
                                                <option value="{{ $department->id }}" <?php if($employeeData[0]->emp_role==$department->id){ echo "selected";}?>>{{ $department->department_name }}</option>
                                                @endforeach
                                            </select>
                                            <p id="department_role_error" class="text-danger"></p>  
                                        </div>
                                        <div class="col-md-3 col-12 form-group">
                                            <label>Shift <span class="text-danger">*</span></label>
                                            <select class="form-control select" name="emp_shift" id="emp_shift">
                                                <option value="">Select</option>
                                                @foreach ($empShift as $shift)
                                                <option value="{{ $shift->id }}" <?php if($employeeData[0]->emp_shift_id==$shift->id){ echo "selected";}?>>{{ $shift->shift_name }}</option>
                                                @endforeach
                                            </select>
                                            <p id="emp_shift_error" class="text-danger"></p>  
                                        </div>
                                        <div class="col-6 form-group">
                                            <label>Designation <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="job_title" id="job_title" value="{{$employeeData[0]->job_title}}">
                                            <p id="job_title_error" class="text-danger"></p>  
                                        </div>
                                        <div class="col-6 form-group">
                                            <label>Technology <span class="text-danger">*</span></label>
                                            <select class="form-control select" name="technology" id="technology">
                                                <option value="">Select</option>
                                                @foreach ($technology as $data)
                                                    <option value="{{ $data->id }}" <?php if($employeeData[0]->technology_id==$data->id){ echo "selected";}?>>{{ $data->tech_name }}</option>
                                                @endforeach
                                            </select>
                                            <p id="technology_error" class="text-danger"></p>  
                                        </div>
                                        <div class="col-md-6 col-12 form-group mb-0">
                                            <p class="mb-2">Employment Type </p>
                                            <div class="custom-control-inline">
                                                <input type="radio"  id="Permanent"
                                                    name="employment_type" value="fte" <?php if($employeeData[0]->employment_type=='fte'){ echo "checked";}?>>
                                                <label for="FTE">FTE</label>
                                            </div>
                                            <div class="custom-control-inline">
                                                <input type="radio"  id="Freelancer"
                                                    name="employment_type" value="contractor" <?php if($employeeData[0]->employment_type=='contractor'){ echo "checked";}?>>
                                        ...
                                        <div class="col-md-6 col-12 form-group">
                                            ...
                                            <select class="form-control select" name="employee_band" id="employee_band">
                                                <option value="">Select</option>
                                                <option value="E1" <?php if($employeeData[0]->employee_band=="E1"){ echo "selected";}?>>E1</option>
                                                <option value="E2" <?php if($employeeData[0]->employee_band=="E2"){ echo "selected";}?>>E2</option>
                                                <option value="E3" <?php if($employeeData[0]->employee_band=="E3"){ echo "selected";}?>>E3</option>
                                                <option value="E4" <?php if($employeeData[0]->employee_band=="E4"){ echo "selected";}?>>E4</option>
                                                <option value="E5" <?php if($employeeData[0]->employee_band=="E5"){ echo "selected";}?>>E5</option>
                                            </select>
                                            <p id="employee_band_error" class="text-danger"></p>  
                                        </div>
                                        <div class="col-md-6 col-12 form-group">
									<p>Employee Type <span class="text-danger">*</span></p>
									<select class="form-control select" required name="is_paid">
										<option value="">Please Select Type</option>
										<option value="1" <?php if($employeeData[0]->is_paid=="1"){ echo "selected";}?>>Paid</option>
										<option value="0" <?php if($employeeData[0]->is_paid=="0"){ echo "selected";}?>>Un-Paid</option>
                                ...
                                <div class="text-center">
                                    <p id="empRegister" type="submit" class="btn btn-theme button-1 text-white ctm-border-radius mt-4"  >Submit</p>
                                </div>
                            </div>
                        </div>
                    </form>
                    <div class="multi_dlex">
                        <div class="uniq_btn_item  ">
                            <input type="submit" onclick="empFunction('registerModal','register_model')" class="multiple_btn" id="{{ $employeeData[0]->user_id }}" value="Edit">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('.msg').html('Data Saved Successfully');
                    var url = '{{route("employee_view", ":id")}}';
    ...
    $("#empRegister").click(function(){
        ...
        $('#emp_name_error').html('');
        if($('#emp_name').val()==''){
            $('#emp_name_error').html('Employee name is required field');
            var error = true;
        }
        ...
        $('#department_role_error').html('');
        if($('#department_role').val()==''){
            $('#department_role_error').html('Role is required field');
            var error = true;
        }
        $('#emp_shift_error').html('');
        if($('#emp_shift').val()==''){
            $('#emp_shift_error').html('Shift is required field');
            var error = true;
        }
        $('#job_title_error').html('');
        if($('#job_title').val()==''){
            $('#job_title_error').html('Job Title is required field');
            var error = true;
        }
        $('#technology_error').html('');
        if($('#technology').val()==''){
            $('#technology_error').html('Job Technology is required field');
            var error = true;
        }
        $('#employee_band_error').html('');
        if($('#employee_band').val()==''){
            $('#employee_band_error').html('Employee Band is required field');
            var error = true;
        }

        $('#dob_error').html('');
        if($('#dob').val()==''){
            $('#dob_error').html('Date Of Birth is required field');
            var error = true;
        }

        $('#employee_salary_error').html('');
        if($('#employee_salary').val()==''){
            $('#employee_salary_error').html('Employee Salary is required field');
            var error = true;
        }

        $('#doj_error').html('');
        if($('#doj').val()==''){
            $('#doj_error').html('Date Of Joining is required field');
            var error = true;
        }
        ...
        $.ajax({
            url: "{{ route('employee_register') }}",
            type: "POST",
            data: $('#registerDetailsform').serialize(),
            dataType: "json",
            beforeSend: function() {
              $("#loader-wrapper").show();
            },
   ...
   $(document).ready(function (e) {
     $("#accountform").on('submit',(function(e) {
        ...
        if($('#pan_number').val().length < 9){
            $('#pan_number_error').html('Pan Number is required field or length should be 9');
            var error = true;
        }
